    ...
    <div>
      ...
      <div className="main">
        ...
        <div className="bigdiv">
          ...
          <p>What do you want to try next? Think of something youwre into like "easy chicken dinner" and see what you find. 
          </p>
          ...
          <div>
            ...
            <button>easy chicken dinner <FontAwesomeIcon icon={faMagnifyingGlass} /></button>
          </div>
        </div>
        <div className="bigdiv">
          ...
          <img src="https://i.pinimg.com/236x/77/3a/75/773a7501929fe1b89d8138e283f02603.jpg" alt="" />
          <img src="https://i.pinimg.com/236x/27/93/7e/27937eb1c379a5db4107bd636aeec640.jpg" alt="" />
        </div>
        <div className="bigdiv">
          <h2>See it, make it, try it, do it</h2>
          <p>The best part of Pinterest is discovering new things and ideas from people around the world.
          </p>
          <button>Explore</button>
